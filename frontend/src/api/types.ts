...
export interface paths {
  ...
  '/preinterview': {
    ...
    put?: never;
    /** Create Preinterview */
    post: operations['create_preinterview_preinterview_post'];
    delete?: never;
    options?: never;
    head?: never;
    patch?: never;
...
export interface components {
  schemas: {
    ...
    VacancyCreateRequest: {
       ...
       * Open Time
       * Format: date-time
       * @default 2025-09-07T19:47:36.393109Z
       */
      open_time: string;
      /** Close Time */
...
export interface operations {
  ...
  edit_application_endpoint_applications__application_id__patch: {
    ...
    responses: {
      ...
      /** @description You are not authorized to transfer this application OR You are not authorized to change status of application OR You are not authorized to change this application */
      403: {
        headers: {
          [name: string]: unknown;
        };
  ...
  create_preinterview_preinterview_post: {
    parameters: {
      query: {
        is_recommended: boolean;
        score: number;
